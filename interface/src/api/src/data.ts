...
export const PRODUCTS: Product[] = [
    new Product(1, 'Visseuse', 'Machine', 24.9, 'https://media.adeo.com/media/1664469/format/png?format=jpg&width=700'),
    new Product(2, 'Perceuse', 'Machine', 41.9, 'https://media.adeo.com/media/1664515/format/png?format=jpg&width=700'),
    new Product(3, 'Perforateur','Machine', 129.0, 'https://media.adeo.com/media/1664470/format/png?format=jpg&width=700'),
    new Product(4, 'Ponceuse','Machine', 79.99, 'https://media.adeo.com/media/1664516/format/png?format=jpg&width=700'),
    new Product(5, 'Polisseuse','Vincent', 69.99, 'https://media.adeo.com/media/1664517/format/png?format=jpg&width=700'),
    new Product(
      6,
      'Foret et mèche',
      'FDP',
